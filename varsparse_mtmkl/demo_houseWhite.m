...
clear Y
%model.Likelihood.sigma2=0.01; % better initial guess
...
if train == 1
    ...
    save(['house_resultWhite_' num2str(noiselevel)])
else
    load(['house_resultWhite_' num2str(noiselevel)])
end
...
axis image
axis off
print -depsc  ./NIPS/figs/houseWhite
if train
save(['house_resultWhite_' num2str(noiselevel)])
end
end