% DEMO  on 10M movielens dataset (rb partition)
clear;
...
if ~exist([ddir, '10MrbData.mat'])
     ...
     % Load training Data
     [users, films, ratings, times] = textread([ddir, 'rb.train'], '%n::%n::%n::%n');
     ...
     [users_test, films_test, ratings_test, times_test] = textread([ddir, 'rb.test'], '%n::%n::%n::%n');
...
save demo_MovieLens10Mrb4_result RMSE_error NMAE_error NMAE_round_error;
